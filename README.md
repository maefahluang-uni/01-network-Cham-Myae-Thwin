[![Open in Codespaces](https://classroom.github.com/assets/launch-codespace-2972f46106e565e64193e422d61a12cf1da4916b45550586e14ef0a7c637dd04.svg)](https://classroom.github.com/open-in-codespaces?assignment_repo_id=20028240)
...
```
 The main() method launches two mock web servers in separate threads on ports 8080 and 8081, waits for the user to press any key, then stops both servers and exits the program.
```
...
```
  -Changing the port number in the constructor.
  -Creating multiple instances with different ports.
  -Update the response string in the MOckWebServer.
  -load testing,parallel testing,different response senerios
```
